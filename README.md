...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Pramodh%20Krishna&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=AI%2FML%20Engineer%20%7C%20Full-Stack%20Developer%20%7C%20M.Tech%20CS%20%40%20NITK&descAlignY=55&descSize=18" width="100%"/>

<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=A970FF&center=true&vCenter=true&width=650&lines=Hi+there%2C+I'm+Pramodh+%F0%9F%91%8B;Building+with+LLMs%2C+RAG+%26+Full-Stack+Web;M.Tech+CS+%40+NITK+Surathkal;Turning+coffee+into+code+%E2%98%95+%E2%86%92+%F0%9F%92%BB" alt="Typing SVG" />
</a>
...
class Pramodh:
    def __init__(self):
        self.role         = "M.Tech CS Student @ NITK Surathkal"
        self.background   = "B.Tech IT @ VIT Vellore (CGPA 9.15)"
        self.focus        = ["LLMs & RAG systems", "Applied ML", "Full-stack web"]
        self.past_interns  = ["Mahindra Group", "nStore Retech", "L&T Technology Services"]
        self.currently_learning = ["Advanced DSA", "System Design"]
...
<table align="center">
<tr>
  <td><b>AI Engineer Intern</b><br/>Mahindra Group</td>
  <td>Fixed a data-leakage bug that had inflated a pricing model's R² to 0.88, retuned CatBoost/LightGBM/XGBoost/PyTorch MLP with Optuna, and shipped a Gemini-powered model-routing service on FastAPI.</td>
</tr>
<tr>
  <td><b>Software Developer Intern</b><br/>nStore Retech</td>
  <td>Built a RAG-based semantic search system over 50,000+ products using Sentence-BERT + Pinecone, and shipped Supabase Edge Functions to replace a dedicated backend for form routing.</td>
</tr>
<tr>
  <td><b>Software Developer Intern</b><br/>L&T Technology Services</td>
  <td>Built Django/PowerShell automation for multi-server deployments, wrote Pytest suites for a large legacy codebase, and ran pentests on the product.</td>
</tr>
</table>
...
<div align="center">
<img src="https://github-readme-activity-graph.vercel.app/graph?username=Pammu10&theme=tokyo-night&hide_border=true" width="100%"/>
</div>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Pammu10/Pammu10/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Pammu10/Pammu10/output/github-contribution-grid-snake.svg" />
  <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/Pammu10/Pammu10/output/github-contribution-grid-snake.svg" />
</picture>
...
<i>"Code is like a joke — if you have to explain it, it's probably bad."</i>
